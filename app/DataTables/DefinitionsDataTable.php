...
class DefinitionsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'dashboard.pages.definitions.action')
            ->rawColumns([
     ...
     *
     * @param \App\Models\Definition $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Definition $model): QueryBuilder
    {
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons' => [
                    [
                        "text" => '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">' . __("New Definition") . '</span>',
    ...
    {
        return 'Definitions_' . date('YmdHis');
    }
}
