    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{url('dashboard')}}/assets/vendor/css/rtl/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{url('dashboard')}}/assets/vendor/css/rtl/theme-default.css" class="template-customizer-theme-css" />
