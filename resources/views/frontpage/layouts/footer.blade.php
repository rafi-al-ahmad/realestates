        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 px-md-0 pt-3">
                <div class="footer_social_widget home5">
                    <h4>{{__('Follow Us')}}</h4>
                    <ul class="mb30">
                        <li class="list-inline-item"><a href="https://www.facebook.com/beynil.realestate"><i class="fa-brands fa-facebook-f"></i></a></li>
                        <li class="list-inline-item"><a href="https://www.instagram.com/beynil.yatirim/"><i class="fa-brands fa-instagram"></i></li>
